...
public class PptMapper {
	...
	public PptMapper image(String variableName, byte[] imageData) {
		...
		return image(variableName, imageData, PptImageReplacementMode.RESIZE_ONLY);
	}
	 ...
	 * @throws IOException 
	 */
	public XMLSlideShow processTemplate(XMLSlideShow templateData) throws IOException {
		return PptTemplates.processPpt(templateData, this);
	}
	// JP mods
	public XMLSlideShow processSlide(XMLSlideShow ppt, XSLFSlide slide) throws IOException {
	
		//System.out.println("processing "+ slide.getSlideNumber() + " "+ slide.getTitle());
		PptTemplates.processShapesContainer(slide, ppt, this);
